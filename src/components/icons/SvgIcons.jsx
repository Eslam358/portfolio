...
export const MongooseIcon = ({ className }) => (
...
export const AxiosIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="#5A29E4">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
  </svg>
);

export const ResponsiveIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="#007AFF">
    <path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z" />
    <path d="M14 8h-4v2h4V8z" />
  </svg>
);
...
export const JwtIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="#0084FF" >
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
  </svg>
);

export const Materialui = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 2"  fill="none">
    <path
      fill="#0073E6"
      fill-rule="evenodd"
